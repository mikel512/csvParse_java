 ...
 */
public class CreateClassFromCsv {
    private boolean annotations = false;

    public CreateClassFromCsv withAnnotations() {
        this.annotations = true;
        return this;
    }

    public void createFile(String csvName, String firstLn) {
        String name = csvName.substring(0, csvName.lastIndexOf('.'));
        File file = createJavaFile(name);
        writeClass(file, firstLn.split(","), name);
    }
    ...
    private void writeClass(File file, String[] firstLn, String csvName) {
        try{
            ...
            for(String prop : firstLn) {
                writer.write(" \tprivate String " + prop + ";\n");
            }
            ...
            for(String prop : firstLn) {
                writer.write(createGetterSetter(prop, false));
            }
